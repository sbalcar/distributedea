 ...
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_initBBOB
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_exitBBOB
 ...
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_exist
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_getFtarget
  (JNIEnv * jenv, jobject obj)
{
    if (jenv == NULL)
        printf("Null obj found.\n");
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_getBest
  (JNIEnv * jenv, jobject obj)
{
    if (jenv == NULL)
        printf("Null obj found.\n");
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_getFbest
  (JNIEnv * jenv, jobject obj)
{
    if (jenv == NULL)
        printf("Null obj found.\n");
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_getEvaluations
  (JNIEnv * jenv, jobject obj)
{
    if (jenv == NULL)
        printf("Null obj found.\n");
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_setNoiseSeed
 ...
 * Signature: ([DII)V
 */
JNIEXPORT void JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_unif
 ...
 * Signature: ([D)D
 */
JNIEXPORT jdouble JNICALL Java_org_distributedea_problems_continuousoptimization_bbobv1502_JNIfgeneric_evaluate
