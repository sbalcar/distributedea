...
import org.distributedea.input.postprocessing.general.matlab.PostProcCountsOfAllottedTimeOfMethods;
import org.distributedea.input.postprocessing.general.matlab.PostProcCountsOfMeritsOfMethodTypes;
import org.distributedea.input.postprocessing.general.matlab.PostProcInvestigationOfInstPresenceOfMethods;
...
public class BatchTestTSP implements IInputBatch {
	...
	public Batch batch() throws IOException {
		...
		jobW2.setPedigreeDefinition(new PedigreeDefinition(PedigreeTree.class));
		...
		jobW4.setPedigreeDefinition(new PedigreeDefinition(PedigreeCounter.class));
		...
		jobW6.setPedigreeDefinition(new PedigreeDefinition(PedigreeTreeFull.class));
