...
public class BatchSingleMethodsVCfrb10040 implements IInputBatch {

	@Override
	public Batch batch() throws Exception {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsVCfrb10040");
		batch.setDescription("Porovnání samostatných metod : VCfrb10040");
