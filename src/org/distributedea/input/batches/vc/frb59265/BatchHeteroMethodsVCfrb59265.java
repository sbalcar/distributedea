...
public class BatchHeteroMethodsVCfrb59265 implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("heteroMethodsVCfrb59265");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : VCfrb59265");
