package org.distributedea.input.batches.matrixfactorization.ml10m100k;
...
public class BatchHeteroMethodsMFML10M100K implements IInputBatch {
	...
	public Batch batch() throws IOException {
		...
		batch.setBatchID("heteroMethodsMFML10M100K");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : MFML10M100K");
