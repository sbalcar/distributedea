package org.distributedea.input.batches.matrixfactorization.ml100k;
...
public class BatchSingleMethodsMFML100k implements IInputBatch {

	@Override
	public Batch batch() throws Exception {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsMFML100k");
		batch.setDescription("Porovnání samostatných metod : MFML100k");
