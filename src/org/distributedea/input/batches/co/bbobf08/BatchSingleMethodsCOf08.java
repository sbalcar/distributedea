...
public class BatchSingleMethodsCOf08 implements IInputBatch {

	@Override
	public Batch batch() throws IOException {

		Batch batch = new Batch();
		batch.setBatchID("singleMethodsCOf08");
		batch.setDescription("Porovnání samostatných metod : COf08");
		
		Job jobI = InputContOpt.test08();
