...
public class BatchSingleMethodsCOf02 implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsCOf02");
		batch.setDescription("Porovnání samostatných metod : COf02");
		
		Job jobI = InputContOpt.test02();
		jobI.setJobID("0");
