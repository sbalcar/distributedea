package org.distributedea.input.batches.machinelearning.zoo;
...
public class BatchSingleMethodsMLZoo implements IInputBatch {
	
	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsMLZoo");
		batch.setDescription("Porovnání samostatných metod : MLZoo");
