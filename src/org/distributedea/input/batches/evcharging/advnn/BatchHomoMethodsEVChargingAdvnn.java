package org.distributedea.input.batches.evcharging.advnn;
...
public class BatchHomoMethodsEVChargingAdvnn implements IInputBatch {
	
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("homoMethodsEVChargingAdvnn");
		batch.setDescription("Porovnání homogenních modelů : EVChargingAdvnn");
