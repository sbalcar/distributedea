...
public class BatchHeteroMethodsEVChargingAdvnn implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("heteroMethodsEVChargingAdvnn");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : EVChargingAdvnn");
