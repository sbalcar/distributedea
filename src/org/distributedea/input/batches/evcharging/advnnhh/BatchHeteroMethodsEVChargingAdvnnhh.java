...
public class BatchHeteroMethodsEVChargingAdvnnhh implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("heteroMethodsEVChargingAdvnnhh");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : EVChargingAdvnnhh");
		...
		String YLABEL = "fitness jako rozptyl odběru el. energie";
