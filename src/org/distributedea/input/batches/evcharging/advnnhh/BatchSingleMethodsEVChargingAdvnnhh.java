...
public class BatchSingleMethodsEVChargingAdvnnhh implements IInputBatch {
	
	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsEVChargingAdvnnhh");
		batch.setDescription("Porovnání samostatných metod : EVChargingAdvnnhh");
