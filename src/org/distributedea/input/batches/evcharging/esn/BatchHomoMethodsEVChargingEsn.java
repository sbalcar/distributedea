package org.distributedea.input.batches.evcharging.esn;
...
public class BatchHomoMethodsEVChargingEsn implements IInputBatch {
	
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("homoMethodsEVChargingEsn");
		batch.setDescription("Porovnání homogenních modelů : EVChargingEsn");
		
		Job jobI = InputEVCharging.test03();
