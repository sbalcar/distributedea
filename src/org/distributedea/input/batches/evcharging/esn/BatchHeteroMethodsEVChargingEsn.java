...
public class BatchHeteroMethodsEVChargingEsn implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("heteroMethodsEVChargingEsn");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : EVChargingEsn");
