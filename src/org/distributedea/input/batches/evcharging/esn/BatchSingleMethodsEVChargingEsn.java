...
public class BatchSingleMethodsEVChargingEsn implements IInputBatch {
	
	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsEVChargingEsn");
		batch.setDescription("Porovnání samostatných metod : EVChargingEsn");
