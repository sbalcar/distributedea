...
public class BatchSingleMethodsEVChargingEsnhh implements IInputBatch {
	
	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("singleMethodsEVChargingEsnhh");
		batch.setDescription("Porovnání samostatných metod : EVChargingEsnhh");
