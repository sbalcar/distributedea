package org.distributedea.input.batches.evcharging.esnhh;
...
public class BatchHomoMethodsEVChargingEsnhh implements IInputBatch {
	
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("homoMethodsEVChargingEsnhh");
		batch.setDescription("Porovnání homogenních modelů : EVChargingEsnhh");
		
		Job jobI = InputEVCharging.test04();
