...
public class BatchHeteroMethodsEVChargingEsnhh implements IInputBatch {

	@Override
	public Batch batch() throws IOException {
		
		Batch batch = new Batch();
		batch.setBatchID("heteroMethodsEVChargingEsnhh");
		batch.setDescription("Porovnání plánovačů v heterogenních modelech : EVChargingEsnhh");
