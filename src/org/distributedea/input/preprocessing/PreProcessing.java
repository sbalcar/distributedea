package org.distributedea.input.preprocessing;
...
public abstract class PreProcessing {
	 ...
	 * @throws FileNotFoundException
	 */
	public static PreProcessing importXML(File file)
			throws FileNotFoundException {
	 ...
	 */
	public static PreProcessing importXML(String xml) {

		XStream xstream = new XStream();
		xstream.setMode(XStream.NO_REFERENCES);

		return (PreProcessing) xstream.fromXML(xml);
	}
