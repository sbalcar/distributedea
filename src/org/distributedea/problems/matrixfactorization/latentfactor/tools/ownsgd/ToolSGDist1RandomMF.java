...
//	static double STEP_ALPHA = 0.0002;
	...
	static void improveObjectRaiting(IndividualLatentFactors idividual,
		...
		LatentFactorModel latFactModel = idividual.getLatentFactorModel();
		LatentFactor latFactX = latFactModel.getLatentFactorX();
		LatentFactor latFactY = latFactModel.getLatentFactorY();
