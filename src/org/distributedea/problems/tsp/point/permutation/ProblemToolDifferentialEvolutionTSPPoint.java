...
import org.distributedea.problems.tsp.point.AProblemToolDifferentialEvolutionTSPPoint;

public class ProblemToolDifferentialEvolutionTSPPoint extends AProblemToolDifferentialEvolutionTSPPoint {
	...
	public Individual differentialOfIndividuals(Individual individual1,
		...
		return OperatorDifferential.create(individualPerm1, individualPerm2,
				individualPerm3);
	}

	@Override
	public Individual cross(Individual individualOld, Individual individualNew, IProblem problem, Dataset dataset,
			IAgentLogger logger) throws Exception {
		...
		Individual[] individualsCreated = OperatorSinglePointCrossover.crossover(
