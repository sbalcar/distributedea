...
import org.distributedea.problems.evcharging.AProblemToolTabuSearchEVCharging;

public class ProblemToolTabuSearchEVChargingRandomMove extends AProblemToolTabuSearchEVCharging {

	private double maxStep;

	@Deprecated
	public ProblemToolTabuSearchEVChargingRandomMove() {
		super();
	}
	 ...
	 * @param maxStep
	 */
	public ProblemToolTabuSearchEVChargingRandomMove(double normalDistMultiplicator, double maxStep) {
