...
public class JNIfgenerica0 extends IJNIfgeneric {
    ...
    public native double initBBOB(int funcId, int instanceId, int dim,
                                  String datapath, JNIfgeneric.Params optParams);
...
/*
        ...
        JNIfgeneric.JNIfgeneric.Params params = new JNIfgeneric.Params();
        int minimum = 1;
        int maximum = 1000;
        int randomNum = minimum + (int)(Math.random() * maximum); 
        
        double ret = fgeneric.initBBOB(1, randomNum, dim, "../data", params);
        if (ret == 0.) {
