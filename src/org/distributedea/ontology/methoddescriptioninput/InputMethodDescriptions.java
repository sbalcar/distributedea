...
public class InputMethodDescriptions implements Concept {
	 ...
	 * @param agentDescriptions
	 */
	public InputMethodDescriptions(InputMethodDescription agentDescription) {
	...
	public InputMethodDescriptions exportIntersection(InputMethodDescriptions methodAgentDescrs) {
	...
	public InputMethodDescriptions exportInputMethodDescriptions() {
		return this;
	}
